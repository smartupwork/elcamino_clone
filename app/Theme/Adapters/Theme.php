 ...
 */
class Theme extends \App\Theme\Theme
{
    public static $page = '';
    ...
    public static function printHtmlClasses($scope, $full = true)
    {
        ...
        \App\Theme\Theme::printHtmlClasses($scope, $full);
    ...
    public static function printHtmlAttributes($scope)
    {
        ...
        // Call the function from core Theme
        \App\Theme\Theme::printHtmlAttributes($scope);
    ...
    public static function printCssVariables($scope)
    {
        ...
        // Call the function from core Theme
        \App\Theme\Theme::printCssVariables($scope);
    ...
    public static function getView($path, $params = array(), $once = false)
    {
        ...
        if (Str::startsWith($path, 'layout')) {
            $path = str_replace('layout', 'theme/layout', $path);
        }


        if (Str::startsWith($path, 'partials')) {
            $path = str_replace('partials', 'theme/partials', $path);
        }
    ...
    {
        return theme()->getThemeAssetsPath().'/media/';
    }
    ...
    {
        $mainConfig   = collect(config('theme'));
        $demoConfig   = config('theme.'. Theme::$demo);
    ...
    public static function getPagePath()
    {
        ...
        $segments = request()->segments();
        if (!empty($segments)) {
            \App\Theme\Theme::$page = implode('/', $segments);
        }

        return \App\Theme\Theme::getPagePath();
    }
